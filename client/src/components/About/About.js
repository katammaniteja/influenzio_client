...
import { MDBCol,MDBIcon, MDBContainer, MDBRow, MDBCard, MDBCardText, MDBCardBody, MDBCardImage, MDBBtn, MDBTypography } from 'mdb-react-ui-kit';
              ...
              <div className="rounded-top text-white d-flex flex-row" style={{ backgroundColor: '#000', height: '250px' }}>
                ...
                <div className="ms-3">
                  ...
                  <MDBRow className="pt-1">
                      ...
                      <MDBTypography tag="h3">Andy Horwitz</MDBTypography>
                      </MDBCol>
                      <MDBCol size="10" className="mb-3">
